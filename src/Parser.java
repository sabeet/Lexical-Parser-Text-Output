...
public abstract class Parser extends LexArithArray
{
	...
	public static void main(String argv[]) {
		...
		//This is where all the inputs go to create an output. It's a custom class built to de-clutter this main method
		OutputSorter.OutputSorter(AL,AL2, argv[1], argv[2]);
